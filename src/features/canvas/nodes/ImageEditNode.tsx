  ...
  for (const token of referenceTokens) {
    ...
    if (imageUrl) {
      ...
      segments.push(
        ...
        >
          {matchText}
          <span className="pointer-events-none absolute left-1/2 top-1/2 inline-flex h-5 w-5 -translate-x-1/2 -translate-y-1/2 items-center justify-center overflow-hidden rounded-[4px] bg-accent/70">
            <img
              src={imageUrl}
              alt={matchText}
              draggable={false}
      ...
      <div className="relative min-h-0 flex-1 rounded-lg border border-[rgba(255,255,255,0.1)] bg-bg-dark/45 p-2">
        <div className="relative h-full min-h-0">
          <div
            ...
            aria-hidden="true"
            className="ui-scrollbar pointer-events-none absolute inset-0 z-20 overflow-y-auto overflow-x-hidden text-sm leading-6 text-text-dark"
